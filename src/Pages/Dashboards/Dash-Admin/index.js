    ...
    <ContentDashboard>
      ...
      <MainDashboard id="main">
        {isCadastrandoCondominio ? (
          <>
            <REgisterCondominio></REgisterCondominio>
            <BtnFecharModal
              onClick={() => {
                setIsCadastrandoCondominio(false);
              }}
            >
              X
            </BtnFecharModal>
        ...
        {isCadastrandoBlocos ? (
          <>
            <RegisterBlocos></RegisterBlocos>
            <BtnFecharModal
              onClick={() => {
                setCadastrandoBlocos(false);
              }}
            >
              X
            </BtnFecharModal>
        ...
        {isCadastrandoApartamento ? (
          <>
            <RegisterApto></RegisterApto>
            <BtnFecharModal
              onClick={() => {
                setCadastrandoApartamento(false);
              }}
            >
              X
            </BtnFecharModal>
        ...
        {isCadastrandoMorador ? (
          <>
            <RegisterMoradores></RegisterMoradores>
            <BtnFecharModal
              onClick={() => {
        ...
        {isCadastrandoSindico ? (
          <>
            <RegisterSindico></RegisterSindico>
            <BtnFecharModal
              onClick={() => {
                setCadastrandoSindico(false);
              }}
            >
              X
            </BtnFecharModal>
        ...
        {isCadastrandoPorteiros ? (
          <>
            <RegisterPorteiros></RegisterPorteiros>
            <BtnFecharModal
              onClick={() => {
                setCadastrandoPorteiros(false);
              }}
            >
              X
            </BtnFecharModal>
      ...
      <aside>
        <ButtonAside
          onClick={() => {
            setIsCadastrandoCondominio(true);
          }}
        >
        ...
        <ButtonAside
          onClick={() => {
            setCadastrandoApartamento(true);
          }}
        >
